                    ...
                    Container(
                      ...
                      child: ButtonBar(
                        ...
                        children: [
                          ...
                          //               content: const Text(
                          //                   "¿Seguro quieres eliminar el pedido?"),
                          //               actions: [
                          //                 TextButton(
                ...
                children: [
                  ...
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        if (_isCreating) // Mostrar el icono de carga si _isCreating es true
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 5),
                            child:
                                CircularProgressIndicator(), // Icono de carga
                          )
                        else // Mostrar los botones "Pedir" y "Cancelar" si _isCreating es false
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 5),
                        ...
                        if (!_isCreating) // Mostrar los botones "Pedir" y "Cancelar" si _isCreating es false
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 5),
                            child: ElevatedButton(
                              onPressed: () async {
